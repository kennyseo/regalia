...
$current_term = "1"."".$current_year."".$term_season;
echo $current_term;

if(date("m") <= '07') {
  $current_commencement = "Spring";
} else {
  $current_commencement = "Fall";
}
*/
...
<h2>Grad Salute - Home Ship</h2>

<form action="gradsalute_homeship2.php?search=
&<? echo $_GET["search"];?>"
method="GET" id="student_homeship">
...
<table bgcolor=#ffffff border=0 cellpadding=5 cellspacing=0 ><tr valign=top>
